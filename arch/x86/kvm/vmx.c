...
#ifdef x86_64
#define arch_width u64
#else
#define arch_width u32
#endif

#define VMCS_ATTR_WRITE(attr_field, type) \
...
#define VMCS_ATTR_READ(attr_field, type) \
...
#define VMCS_ATTR_DEF(attr_field, type, perms, read, write) \
static struct kobj_attribute vmcs_field_##attr_field = \
	__ATTR(attr_field, perms, read, write);

#define VMCS_ATTR(attr_field, type) VMCS_ATTR_WRITE(attr_field, type) \
	VMCS_ATTR_READ(attr_field, type) \
	VMCS_ATTR_DEF(attr_field, type, 0644, vmcs_##attr_field##_show, \
			vmcs_##attr_field##_store)

#define VMCS_ATTR_RO(attr_field, type) \
	VMCS_ATTR_READ(attr_field, type) \
	VMCS_ATTR_DEF(attr_field, type, 0444, vmcs_##attr_field##_show, NULL)
...
VMCS_ATTR(CR0_GUEST_HOST_MASK, arch_width);
VMCS_ATTR(CR4_GUEST_HOST_MASK, arch_width);
VMCS_ATTR(CR0_READ_SHADOW, arch_width);
VMCS_ATTR(CR4_READ_SHADOW, arch_width);
VMCS_ATTR(CR3_TARGET_VALUE0, arch_width);
VMCS_ATTR(CR3_TARGET_VALUE1, arch_width);
VMCS_ATTR(CR3_TARGET_VALUE2, arch_width);
VMCS_ATTR(CR3_TARGET_VALUE3, arch_width);
VMCS_ATTR_RO(EXIT_QUALIFICATION, arch_width);
VMCS_ATTR_RO(GUEST_LINEAR_ADDRESS, arch_width);
VMCS_ATTR(GUEST_CR0, arch_width);
VMCS_ATTR(GUEST_CR3, arch_width);
VMCS_ATTR(GUEST_CR4, arch_width);
VMCS_ATTR(GUEST_ES_BASE, arch_width);
VMCS_ATTR(GUEST_CS_BASE, arch_width);
VMCS_ATTR(GUEST_SS_BASE, arch_width);
VMCS_ATTR(GUEST_DS_BASE, arch_width);
VMCS_ATTR(GUEST_FS_BASE, arch_width);
VMCS_ATTR(GUEST_GS_BASE, arch_width);
VMCS_ATTR(GUEST_LDTR_BASE, arch_width);
VMCS_ATTR(GUEST_TR_BASE, arch_width);
VMCS_ATTR(GUEST_GDTR_BASE, arch_width);
VMCS_ATTR(GUEST_IDTR_BASE, arch_width);
VMCS_ATTR(GUEST_DR7, arch_width);
VMCS_ATTR(GUEST_RSP, arch_width);
VMCS_ATTR(GUEST_RIP, arch_width);
VMCS_ATTR(GUEST_RFLAGS, arch_width);
VMCS_ATTR(GUEST_PENDING_DBG_EXCEPTIONS, arch_width);
VMCS_ATTR(GUEST_SYSENTER_ESP, arch_width);
VMCS_ATTR(GUEST_SYSENTER_EIP, arch_width);
VMCS_ATTR(HOST_CR0, arch_width);
VMCS_ATTR(HOST_CR3, arch_width);
VMCS_ATTR(HOST_CR4, arch_width);
VMCS_ATTR(HOST_FS_BASE, arch_width);
VMCS_ATTR(HOST_GS_BASE, arch_width);
VMCS_ATTR(HOST_TR_BASE, arch_width);
VMCS_ATTR(HOST_GDTR_BASE, arch_width);
VMCS_ATTR(HOST_IDTR_BASE, arch_width);
VMCS_ATTR(HOST_IA32_SYSENTER_ESP, arch_width);
VMCS_ATTR(HOST_IA32_SYSENTER_EIP, arch_width);
VMCS_ATTR(HOST_RSP, arch_width);
VMCS_ATTR(HOST_RIP, arch_width);
